...
> **Branch note:** `feature/window-menu` adds a top menu bar to the application. The File/Window/Help menus are wired up; the Info menu (per-distribution info popup) is a work in progress.

## Features

- Interactive GUI with an embedded matplotlib canvas
- Top menu bar: **File**, **Window**, **Help**, and (WIP) **Info**
...
- **Info → About** — opens a Toplevel window intended to show information about the currently selected distribution. Still WIP: the current selection isn't yet passed through correctly.
...
GUI updates:
- Themes
- Info section for distributions *(in progress on this branch)*
